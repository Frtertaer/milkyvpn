...
class S {
  ...
  String get chooseCountry => t('Выберите страну', 'Choose a country');
  String get reportDetails => t('Детали отчёта', 'Report details');
  ...
  String get noSubscriptionYet =>
      t('У меня пока нет подписки', "I don't have a subscription yet");
  ...
  String get countsNeedRefresh => t(
    'Обновите подписку, чтобы уточнить количество профилей.',
    'Refresh the subscription to verify profile counts.',
  );
  String get countsNotVerified =>
      t('Количество требует обновления', 'Counts need refresh');
  String profilesFound(int n) => counted(
    n,
    'профиль найден',
    'профиля найдено',
    'профилей найдено',
  ...
  String profilesCompatible(int n) => counted(
    n,
    'совместим с приложением',
    'совместимы с приложением',
    'совместимых с приложением',
    'compatible with the app',
    'compatible with the app',
  );
  String profilesIncompatible(int n) => counted(
    n,
    'не поддерживается',
    'не поддерживаются',
    'не поддерживаются',
  ...
  String linesParsed(int n) => counted(
    n,
    'строка в подписке',
    'строки в подписке',
    'строк в подписке',
    'line in the subscription',
    'lines in the subscription',
  );
  String duplicatesSkipped(int n) => counted(
    n,
    'повтор пропущен',
    'повтора пропущено',
    'повторов пропущено',
  ...
  String malformedSkipped(int n) => counted(
    n,
    'строка повреждена',
    'строки повреждены',
    'строк повреждено',
  ...
  String profilesShort(int n) =>
      counted(n, 'профиль', 'профиля', 'профилей', 'profile', 'profiles');
  String compatibleShort(int n) => counted(
    n,
    'совместимый',
    'совместимых',
    'совместимых',
  ...
  String get removeConfirm => t(
    'Удалить подписку с этого устройства? Вы сможете добавить её снова.',
    'Remove the subscription from this device? You can add it again later.',
  );
  ...
  String subActiveUntil(String date) =>
      t('Подписка активна · до $date', 'Subscription active · until $date');
  String get subActiveForever =>
      t('Подписка активна · бессрочно', 'Subscription active · no expiry');
  String get subscriptionHint => t(
    'Подписка хранится только на этом устройстве.',
    'The subscription is stored on this device only.',
  );
  ...
  String get pasteFromClipboard =>
      t('Вставить из буфера', 'Paste from clipboard');
  String get pasted =>
      t('Вставлено из буфера обмена', 'Pasted from the clipboard');
  String get clipboardEmpty =>
      t('В буфере обмена нет ссылки', 'No link in the clipboard');
  String get subscriptionUrlHint =>
      t('Ссылка на подписку', 'Subscription link');
  ...
  String get autoConnectHint =>
      t('Подключаться при запуске приложения', 'Connect when the app starts');
    ...
    switch (kind) {
      ...
      case MilkyErrorKind.tunnelFailed:
        return t(
          ...
          'The tunnel did not start. Try again or pick another server.',
        );
      case MilkyErrorKind.noServers:
        return t(
          'В подписке нет серверов, которые поддерживает приложение. Обновите подписку.',
          'The subscription has no servers this app can run. Refresh it.',
        );
      case MilkyErrorKind.subscriptionProblem:
        return t(
  ...
  String errorAction(MilkyErrorAction action) {
    switch (action) {
      ...
      case MilkyErrorAction.chooseServer:
        return t('Выбрать страну', 'Choose a country');
