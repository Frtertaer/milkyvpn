          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  title,
                  style: MilkyType.subtitle.copyWith(color: titleColor),
                ),
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: value
                ? null
                : (c.isDark ? c.surfaceRaised : const Color(0xFFE2DFD8)),
            boxShadow: value
                ? [
                    BoxShadow(
          ...
          child: Align(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: value
                    ? Colors.white
                    : (c.isDark ? c.textMuted : Colors.white),
...
class MilkySegmented<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = context.milky;
    final vertical = MediaQuery.textScalerOf(context).scale(14) > 19;
    return Container(
            ...
            Flexible(
              ...
              child: MilkyPressable(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: v == selected
                        ? (c.isDark ? c.accentSoft : Colors.white)
                        : Colors.transparent,
                  ...
                  child: Text(
                    ...
                    style: MilkyType.chip.copyWith(
                      color: v == selected ? c.text : c.textMuted,
                    ),
                  ),
                ),
              ),
